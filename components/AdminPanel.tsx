          ...
          <div className="space-y-2">
            {sessions.map(s => (
              <button
                ...
                className={`w-full text-left px-4 py-3 rounded-2xl text-[11px] font-black transition-all ${
          ...
          <div className="bg-gray-900 p-6 rounded-3xl text-white shadow-xl">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white/5 p-3 rounded-2xl">
                ...
                <div className="text-[8px] font-black text-gray-500 uppercase">Respondenti</div>
              </div>
              <div className="bg-white/5 p-3 rounded-2xl">
